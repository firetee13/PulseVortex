    ...
    if records_to_fix:
        ...
        if response.lower() == 'y':
            ...
            for record in records_to_fix:
                ...
                rounded_rrr = round(calculated_rrr, decimal_places + 2)  # Extra precision for RRR
                ...
                try:
                    ...
                    if fixed_count <= 5:  # Show first 5 fixes
                        print(f"Fixed RowID {rowid}: {record['symbol']} - RRR {record['stored_rrr']:.6f} → {rounded_rrr:.6f}")
